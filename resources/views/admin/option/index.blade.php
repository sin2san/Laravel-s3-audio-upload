                    ...
                    <div class="col-md-8 col-md-pull-4">
                        <div class="box-body">
                            ...
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="image-box img-thumbnail"
                                                    style="background-image: url('{{ asset('storage/options/' . $singleData->logo) }}');">
                                                    <div class="image-close"><a
                                                            href="{{ url('admin/options/delete-logo') }}"><i
                                ...
                                <div class="col-md-6 form-group {!! $errors->has('favicon') ? 'has-error' : '' !!}">
                                    {!! Form::label('Favicon') !!}
                                    ...
                                    @if ($singleData->favicon)
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="image-box img-thumbnail"
                                                    style="background-image: url('{{ asset('storage/options/' . $singleData->favicon) }}');">
                                                    <div class="image-close"><a
                                                            href="{{ url('admin/options/delete-favicon') }}"><i
                                                                class="fa fa-close"></i></a></div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-default" href="{{ url('admin/dashboard') }}"><i
